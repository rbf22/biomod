...
class TestBondInference:
    ...
    def test_can_infer_bonds(self, mock_radius):
        ...
        residue.infer_bonds()
        assert self.atom1.bonded_atoms == {self.atom2}
        assert self.atom2.bonded_atoms == {self.atom1}
        assert self.atom3.bonded_atoms == set()
    ...
    def test_can_infer_bonds_with_tolerance(self, mock_radius):
        ...
        assert self.atom1.bonded_atoms == {self.atom4}
        assert self.atom4.bonded_atoms == {self.atom1}
    ...
    def test_infer_bonds_needs_tolerance(self, mock_radius):
        ...
        assert self.atom1.bonded_atoms == set()
        assert self.atom4.bonded_atoms == set()

...
class TestDebugMmtf:
    ...
    def test_can_save_1lol_mmtf(self, file_saving_fixture):
        check_file_saving("1lol.mmtf")

    def test_can_save_1xda_mmtf(self, file_saving_fixture):
...
class TestDebugPdb:
    ...
    def test_can_save_1lol_pdb(self, file_saving_fixture):
        check_file_saving("1lol.pdb")

    def test_chain_save_debug(self, file_saving_fixture):
